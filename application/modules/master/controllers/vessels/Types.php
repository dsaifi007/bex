...
class Types extends AdminMaster {

    protected $item_ID;
    protected $parent_dir = 'vessels';
    protected $list_link = 'vessels/types';
    protected $tbl = 'vessels_types';
    
    protected $model_name = 'vessels/Type_model';
    protected $model = 'type_model';
    ...
    private function _initEnv() {
        $this->lang->load($this->parent_dir.'/types');
        $this->_loadModelEnv();
    }
    ...
    public function index() {
        ...
        if (count($data['items']) > 0) :
            ...
            $this->minify->add_js($this->th_custom_js_path.$this->parent_dir.'/types.js', 'page');
        endif;

        $data['list_link'] = $this->setAppURL($this->list_link);
        $data['view_name'] = $this->parent_dir.'/types';
        $data['view_class'] = 'types';
    ...
    private function _initBasicFormEnv($data) {
        ...
        $data['list_link'] = $this->setAppURL($this->list_link);
        $this->minify->add_js($this->th_custom_js_path.$this->parent_dir.'/type_form.js', 'page');
        $data['view_name'] = $this->parent_dir.'/type_form';
        $data['view_class'] = 'type_blk';
        return $data;
    }
    ...
    protected function doFormValidation() {
        ...
        $this->form_validation->set_rules('type_name', 'lang:err_type_name', 'trim|required|min_length[2]|max_length[50]'.$is_unique);
    ...
    protected function FormProcess($data) {
        ...
        if ($this->doFormValidation()) :
            ...
            if ($item_id) :
                $data['success'] = $this->lang->line('success_type_save');
            ...
            else : $data['error'] = $this->lang->line('err_type_save');
            endif;
        endif;
    ...
    public function delete($id) {
        ...
        $this->session->set_flashdata('flashSuccess', $this->lang->line('success_type_delete'));
        $this->deleteCache($this->tbl . '*');
