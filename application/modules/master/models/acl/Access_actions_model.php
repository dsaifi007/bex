...
class Access_actions_model extends RPTAPP_Model {
	
	protected $_table = 'acl_access_actions';
	protected $_fields = ['id'=> 0, 'acl_action'=> '', 'modified_by' => 0, 'modified_on' => '', 'published' => 1];
	protected $db_Select_m = ['a.*'];
	protected $db_Order_m = ['a.acl_action'=> 'asc'];
