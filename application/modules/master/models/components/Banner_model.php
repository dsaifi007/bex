...
class Banner_model extends RPTAPP_Model {
	
	protected $_table = 'banners';
	protected $_fields = ['id'=> 0, 'banner_name'=> '', 'banner_image'=>'', 'click_url'=>'', 'description'=>'', 'parent_id'=>0, 'item_ordering'=>0, 'category_id'=>0, 'banner_width'=>'', 'banner_height'=>'', 'modified_by' => 0, 'modified_on' => '', 'published' => 1];
	protected $db_Select_m = ['a.*', 'b.category_name', 'c.title as domain'];
    protected $db_Joins_m = [
        ['banner_categories as b', 'a.category_id = b.id', 'left'],
