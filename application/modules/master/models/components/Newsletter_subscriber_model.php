...
class Newsletter_subscriber_model extends RPTAPP_Model {
	
	protected $_table = 'newsletter_subscribers';
	protected $_fields = ['id'=> 0, 'subs_email'=> '','subs_name'=>'', 'modified_by' => 0, 'modified_on' => '', 'published' => 1];
	protected $db_Select_m = ['a.*'];
	protected $db_Order_m = ['a.subs_email'=> 'asc'];
