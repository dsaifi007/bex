...
class Testimonial_category_model extends RPTAPP_Model {

    protected $_table = 'testimonials_categories';
    protected $_fields = ['id'=> 0, 'category_name'=> '', 'domain_id' => 0, 'modified_by' => 0, 'modified_on' => '', 'published' => 1];
    protected $db_Select_m = ['a.*', 'b.title as domain'];
    protected $db_Joins_m = [
        ['domains as b', 'b.id = a.domain_id', 'left']
    ];
    protected $db_Order_m = ['a.category_name'=> 'asc'];
