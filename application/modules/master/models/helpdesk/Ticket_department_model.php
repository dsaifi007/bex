...
class Ticket_department_model extends RPTAPP_Model {
	
	protected $_table = 'helpdesk_ticket_departments';
	protected $_fields = ['id'=> 0, 'department_name'=> '', 'domain_id'=>0, 'modified_by' => 0, 'modified_on' => '', 'published' => 1];
	protected $db_Select_m = ['a.*'];
	protected $db_Order_m = ['a.department_name'=> 'asc'];
