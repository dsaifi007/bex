...
class Ticket_model extends RPTAPP_Model {
	...
	protected $_table = 'helpdesk_tickets';
	protected $_fields = ['id'=> 0, 'ticket_subject'=> '','status_id'=>'','category_id'=>'','priority_id'=>'','product_id'=>'','modified_by' => 0, 'modified_on' => '', 'published' => 1];
	protected $db_Select_m = ['a.*'];
	protected $db_Order_m = ['a.ticket_subject'=> 'asc'];
