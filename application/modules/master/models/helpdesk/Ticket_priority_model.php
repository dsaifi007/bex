...
class Ticket_priority_model extends RPTAPP_Model {
	
	protected $_table = 'helpdesk_ticket_priorities';
	protected $_fields = ['id'=> 0, 'ticket_priority'=> '', 'item_ordering'=> 0, 'parent_id'=>0, 'modified_by' => 0, 'modified_on' => '', 'published' => 1];
