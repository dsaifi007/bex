...
class Order_payment_method_model extends RPTAPP_Model {
	
	protected $_table = 'vessels_inspection_orders_payment_methods';
	protected $_fields = ['id'=> 0, 'method_name'=> '','modified_by' => 0, 'modified_on' => '', 'published' => 1];
	protected $db_Select_m = ['a.*'];
    protected $db_Order_m = ['a.id'=>'asc', 'a.method_name'=>'asc'];
