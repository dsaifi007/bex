...
class Order_status_model extends RPTAPP_Model {
	
	protected $_table = 'vessels_inspection_order_status';
	protected $_fields = ['id'=> 0, 'order_status'=> '','parent_id'=>0,'item_ordering' => 0,'modified_by' => 0, 'modified_on' => '', 'published' => 1];
