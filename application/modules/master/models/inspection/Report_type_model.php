...
class Report_type_model extends RPTAPP_Model {
	
	protected $_table = 'vessels_inspection_report_types';
	protected $_fields = ['id'=> 0, 'type_name'=> '', 'featured'=> 0, 'drive_type_id'=> 0, 'no_of_drives'=>'', 'modified_by' => 0, 'modified_on' => '', 'published' => 1];
	protected $db_Select_m = ['a.*', 'b.drive_type_name'];
	protected $db_Joins_m = [
		['vessels_drive_types as b', 'a.drive_type_id = b.id', 'left'],                  
	];
    protected $db_Order_m = ['a.type_name'=>'asc'];
