...
class Brand_model extends RPTAPP_Model {
	
	protected $_table = 'bex_brands';
	protected $_fields = ['id'=> 0, 'brand_name'=> '','toxic'=>0,'modified_by' => 0, 'modified_on' => '', 'published' => 1];
	protected $db_Select_m = ['a.*'];
    protected $db_Order_m = ['a.brand_name'=>'asc'];
