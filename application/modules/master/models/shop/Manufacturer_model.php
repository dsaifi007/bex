...
class Manufacturer_model extends RPTAPP_Model {
	
	protected $_table = 'shop_manufacturers';
	protected $_fields = ['id'=> 0, 'manufacturer'=> '', 'modified_by' => 0, 'modified_on' => '', 'published' => 1, 'stores'=>[]];
	protected $db_Select_m = ['a.*', 'group_concat(b.store_id) as stores'];
    protected $db_Joins_m = [
        ['shop_stores_manufacturers_map as b', 'a.id = b.manufacturer_id', 'left']
    ];
    protected $db_Groups_m = ['a.id'];
	protected $db_Order_m = ['a.manufacturer'=> 'asc'];
    ...
    protected $_table_mapping = [
        'shop_stores_manufacturers_map' => ['fkey' => 'manufacturer_id', 'map_fields' => ['stores' => 'store_id'], 'post_field' => 'stores']
    ];
