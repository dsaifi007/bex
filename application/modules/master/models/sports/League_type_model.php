...
class League_type_model extends RPTAPP_Model {
	
	protected $_table = 'sports_leagues_types';
	protected $_fields = ['id'=> 0, 'type_name'=> '','modified_by' => 0, 'modified_on' => '', 'published' => 1];
	protected $db_Select_m = ['a.*'];
    protected $db_Order_m = ['a.id'=>'asc', 'a.type_name'=>'asc'];
