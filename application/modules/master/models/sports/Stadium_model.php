...
class Stadium_model extends RPTAPP_Model {
	protected $_table = 'sports_stadiums';

	protected $_fields = ['id'=> 0,'stadium_name'=>'','country_code'=>'','description'=>'','item_image'=>'','state'=>'', 'state_code'=>'', 'city'=>'','zipcode'=>'','modified_by'=>0, 'modified_on'=>'', 'published'=> 1];
	protected $db_Select_m = ['a.*'];
    protected $db_Order_m = ['a.stadium_name'=>'asc'];
