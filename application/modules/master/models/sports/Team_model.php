...
class Team_model extends RPTAPP_Model {
	
	protected $_table = 'sports_teams';
	protected $_fields = ['id'=> 0, 'team_name'=> '', 'league_type_id'=>0, 'country_code'=>'', 'modified_by' => 0, 'modified_on' => '', 'published' => 1];
	protected $db_Select_m = ['a.*'];
    protected $db_Order_m = ['a.team_name'=>'asc'];
