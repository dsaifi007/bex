...
class Usergroup_model extends RPTAPP_Model {
	
	protected $_table = 'users_groups';
	protected $_fields = ['id'=> 0, 'parent_id'=> '', 'title'=>'', 'modified_by' => 0, 'modified_on' => '', 'published' => 1];
	protected $db_Select_m = ['a.*'];
	
	protected $db_Order_m = ['a.parent_id'=> 'asc', 'a.title'=>'asc'];
        
        protected $before_update = ['timeStamps(modified_on)', 'alterItemBy(modified_by)'];
        protected $after_update = ['manageParentGroupOrder_OwnTable'];
