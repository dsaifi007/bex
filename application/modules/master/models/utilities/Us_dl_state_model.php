...
class Us_dl_state_model extends RPTAPP_Model {
	
	protected $_table = 'us_dl_states';
	protected $_fields = ['id'=> 0, 'state_name'=> '', 'modified_by' => 0, 'modified_on' => '', 'published' => 1];
	protected $db_Select_m = ['a.*'];
	protected $db_Order_m = ['a.state_name'=> 'asc'];
