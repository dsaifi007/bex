...
class Zipcode_model extends RPTAPP_Model {
	
	protected $_table = 'zip_codes';
	protected $_fields = ['id'=> 0, 'zip_code'=> '', 'city'=>'', 'county'=>'', 'state_name'=>'', 'state_prefix'=>'', 'lat'=>'', 'lon'=>'', 'country_code'=>'', 'modified_by' => 0, 'modified_on' => '', 'published' => 1];
	protected $db_Select_m = ['a.*'];
	protected $db_Order_m = ['a.zip_code'=> 'asc'];
