...
class Anode_type_model extends RPTAPP_Model {
	
	protected $_table = 'vessels_anode_types';
	protected $_fields = ['id'=> 0, 'anode_type_name'=> '', 'currency_code' => '', 'modified_by' => 0, 'modified_on' => '', 'published' => 1];
	protected $db_Select_m = ['a.*'];
    protected $db_Order_m = ['a.anode_type_name'=>'asc'];
