...
class Drive_type_model extends RPTAPP_Model {
	
	protected $_table = 'vessels_drive_types';
	protected $_fields = ['id'=> 0, 'drive_type_name'=> '','modified_by' => 0, 'modified_on' => '', 'published' => 1];
	protected $db_Select_m = ['a.*'];
    protected $db_Order_m = ['a.drive_type_name'=>'asc'];
