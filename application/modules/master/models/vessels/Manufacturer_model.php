...
class Manufacturer_model extends RPTAPP_Model {
	...
	protected $_table = 'vessels_manufacturers';
	protected $_fields = ['id'=> 0, 'manufacturer_name'=> '','modified_by' => 0, 'modified_on' => '', 'published' => 1];
	protected $db_Select_m = ['a.*'];
    protected $db_Order_m = ['a.manufacturer_name'=>'asc'];
