...
class Price_type_model extends RPTAPP_Model {
	
	protected $_table = 'vessels_price_types';
	protected $_fields = ['id'=> 0, 'type_name'=> '', 'parent_id'=>0, 'currency_code' => '', 'display_type' => 0, 'item_ordering' => 0, 'modified_by' => 0, 'modified_on' => '', 'published' => 1];
