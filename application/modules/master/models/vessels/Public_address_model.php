...
class Public_address_model extends RPTAPP_Model {
	
	protected $_table = 'vessels_public_addresses';
	protected $_fields = ['id'=> 0, 'marina_name'=>'', 'address'=>'', 'zip_code'=>'', 'city'=>'', 'state_name'=>'', 'state_prefix'=>'', 'country_code'=>'', 'security_code'=> '', 'modified_by' => 0, 'modified_on' => '', 'published' => 1];
	protected $db_Select_m = ['a.*'];
	protected $db_Order_m = ['a.marina_name'=> 'asc'];
