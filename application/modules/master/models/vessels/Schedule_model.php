...
class Schedule_model extends RPTAPP_Model {
	
	protected $_table = 'vessels_schedule';
	protected $_fields = ['id'=> 0, 'schedule_name'=> '','range_from'=> '','range_to'=> '','modified_by' => 0, 'modified_on' => '', 'published' => 1];
	protected $db_Select_m = ['a.*'];
    protected $db_Order_m = ['a.schedule_name'=>'asc'];
