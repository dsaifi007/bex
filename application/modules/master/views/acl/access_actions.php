...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_acl_action'), 'class' => 'left', 'width' => '35%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover acl_actions_list">'];
