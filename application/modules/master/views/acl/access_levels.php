...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_acl_level'), 'class' => 'left', 'width' => '20%'],
    ['data' => $this->lang->line('tb_hd_acl_level_usergroups'), 'class' => 'left hidden-xs', 'width' => '30%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover acl_levels_list">'];
            ...
            <div class="portlet-body">
                ...
                if (count($items) > 0) :
                    ...
                    foreach ($items as $k => $v) :
                        ...
                        $rowdata = [];
                        $rowdata[] = ['data' => $v->acl_level];
                        $rowdata[] = ['data' => display_to_do_list(array_filter($groups)), 'class'=> 'hidden-xs'];
