...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_acl_content_title'), 'class' => 'left', 'width' => '25%'],
    ['data' => $this->lang->line('tb_hd_acl_content_type'), 'class' => 'left hidden-xs', 'width' => '10%'],
    ['data' => $this->lang->line('tb_hd_acl_access_level'), 'class' => 'left hidden-xs', 'width' => '15%'],
    ['data' => $this->lang->line('tb_hd_acl_content_domain'), 'class' => 'left hidden-xs', 'width' => '15%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover acl_content_list">'];
            ...
            <div class="portlet-body">
                ...
                if (count($items) > 0) :
                    ...
                    foreach ($items as $k => $v) :
                        ...
                        $rowdata[] = ['data' => $seprator.$v->content_title];
                        $rowdata[] = ['data' => display_status_btn($v->content_type, $content_type_arr), 'class'=> 'hidden-xs'];
                        $rowdata[] = ['data' => $v->acl_level, 'class'=> 'hidden-xs'];
                        $rowdata[] = ['data' => $v->domain_title, 'class'=> 'hidden-xs'];
