...
$table_heads = [
    ...
    ['data' => $this->lang->line('tb_hd_vessel_cleaning_date'), 'class' => 'left', 'width' => '10%'],
    ['data' => $this->lang->line('tb_hd_vessel_assigned_divers'), 'class' => 'left', 'width' => '25%'],
    ['data' => $this->lang->line('tb_hd_vessel_cleaning_status'), 'class' => 'left', 'width' => '10%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover cleaning_schedule_list">'];
$template_active1 = ['table_open' => '<table class="table table-striped table-bordered table-hover cleaning_schedule_list1">'];
...
<div class="row">
    <div class="col-md-12">
        <div class="portlet light bordered">
            <?php echo display_message_info(['0' => $error, '1' => $success]); ?>
            <?php echo display_portlet_title($this->lang->line('table_head_label_past_schedules')); ?>
            <div class="portlet-body">
                <?php
                    $this->table->set_template($template_active1);
                    $this->table->set_heading($table_heads);
                    echo $this->table->generate();
                ?>
            </div>
