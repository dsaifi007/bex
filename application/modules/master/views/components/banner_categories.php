...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_banner_category_name'), 'class' => 'left', 'width' => '30%'],
    ['data' => $this->lang->line('tb_hd_banner_category_domain'), 'class' => 'left', 'width' => '25%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover banner_categories_list">'];
