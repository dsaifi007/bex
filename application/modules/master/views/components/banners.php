...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_banner'), 'class' => 'left', 'width' => '25%'],
    ['data' => $this->lang->line('tb_hd_banner_category'), 'class' => 'left', 'width' => '35%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover banners_list">'];
