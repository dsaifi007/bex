...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_extensions'), 'class' => 'left', 'width' => '30%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover extensions_list">'];
