...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_extension_positions'), 'class' => 'left', 'width' => '30%'],
	['data' => $this->lang->line('tb_hd_ext_domain'), 'class' => 'left', 'width' => '25%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover extensions_positions_list">'];
            ...
            <div class="portlet-body">
                ...
                if (count($items) > 0) :
                    ...
                    foreach ($items as $k => $v) :
                        ...
                        $rowdata = [];
						$rowdata[] = ['data' => $v->position_name];
                        //$rowdata[] = ['data' => text_wrapping($v->description, 50)];
						$rowdata[] = ['data' => $v->domain];
