...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_post'), 'class' => 'left', 'width' => '20%'],
    ['data' => $this->lang->line('tb_hd_domain'), 'class' => 'left', 'width' => '20%'],
	['data' => $this->lang->line('tb_hd_post_category'), 'class' => 'left', 'width' => '20%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover posts_list">'];
?>
