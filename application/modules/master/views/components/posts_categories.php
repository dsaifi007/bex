...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_title'), 'class' => 'left', 'width' => '40%'],
    ['data' => $this->lang->line('tb_hd_domain'), 'class' => 'left', 'width' => '20%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover posts_categories_list">'];
