...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_testimonial_categories'), 'class' => 'left', 'width' => '40%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover testimonial_categories_list">'];
            ...
            <div class="portlet-body">
                ...
                if (count($items) > 0) :
                    ...
                    foreach ($items as $k => $v) :
                        ...
                        $rowdata = [];
                        //$rowdata[] = ['data' => substr($v->content,0,50)."...."];
