...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_testimonial'), 'class' => 'left', 'width' => '30%'],
    ['data' => $this->lang->line('tb_hd_testimonial_name'), 'class' => 'left', 'width' => '15%'],
	['data' => $this->lang->line('tb_hd_testimonial_category'), 'class' => 'left', 'width' => '15%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover testimonials_list">'];
            ...
            <div class="portlet-body">
                ...
                if (count($items) > 0) :
                    ...
                    foreach ($items as $k => $v) :
                        ...
                        $rowdata = [];
                        $rowdata[] = ['data' => text_wrapping($v->content, 50)];
                        $rowdata[] = ['data' => $v->client_name];
						//$rowdata[] = ['data' => $v->category_name.' | '.$v->domain];
                        $rowdata[] = ['data' => $v->category_name];
