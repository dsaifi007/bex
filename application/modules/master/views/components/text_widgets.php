...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_widget_name'), 'class' => 'left', 'width' => '35%'],
    ['data' => $this->lang->line('tb_hd_widget_domain'), 'class' => 'text-center', 'width' => '20%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover text_widgets_list">'];
            ...
            <div class="portlet-body">
                ...
                if (count($items) > 0) :
                    ...
                    foreach ($items as $k => $v) :
                        ...
                        $rowdata = [];
                        $rowdata[] = ['data' => $v->widget_name];
                        $rowdata[] = ['data' => $v->domain, 'class' => 'text-center'];
