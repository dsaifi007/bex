...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_title'), 'class' => 'left', 'width' => '45%'],
    ...
    ['data' => $this->lang->line('tb_hd_actions'), 'class' => 'text-center', 'width' => '15%']
];

$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover categories_list">'];
...
$remove_btn = authenticate_acl_action($this->hook_data->access_functions, $this->router->fetch_method(), 'ticket_categories_delete_btn', 'view', $this->userdata->user_groups);
?>
            ...
            <div class="portlet-body">
                ...
                if (count($items) > 0) :
                    ...
                    foreach ($items as $k => $v) :
                        ...
                        $rowdata[] = ['data' => $seprator.$v->category_name];
