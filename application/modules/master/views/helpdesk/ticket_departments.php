...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_ticket_departments'), 'class' => 'left', 'width' => '35%'],
    ['data' => $this->lang->line('tb_hd_ticket_department_domain'), 'class' => 'left', 'width' => '20%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover ticket_departments_list">'];
...
$remove_btn = authenticate_acl_action($this->hook_data->access_functions, $this->router->fetch_method(), 'ticket_departments_delete_btn', 'view', $this->userdata->user_groups);
?>
            ...
            <div class="portlet-body">
                ...
                if (count($items) > 0) :
                    ...
                    foreach ($items as $k => $v) :
                        ...
                        $rowdata = [];
                        $rowdata[] = ['data' => $v->department_name];
                        $rowdata[] = ['data' => (isset($domain_list[$v->domain_id]))? $domain_list[$v->domain_id]:''];
