...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_ticket_status'), 'class' => 'left', 'width' => '35%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover ticket_status_list">'];
...
$remove_btn = authenticate_acl_action($this->hook_data->access_functions, $this->router->fetch_method(), 'ticket_status_delete_btn', 'view', $this->userdata->user_groups);
?>
