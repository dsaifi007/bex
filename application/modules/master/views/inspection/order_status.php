...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_order_status_name'), 'class' => 'left', 'width' => '35%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover order_status_list">'];
