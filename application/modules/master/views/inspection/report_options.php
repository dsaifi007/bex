...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_report_option_name'), 'class' => 'left', 'width' => '25%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover report_options_list">'];
            ...
            <div class="portlet-body">
                ...
                if (count($items) > 0) : 
                    ...
                    foreach ($items as $k => $v) :  
                        ...
                        $rowdata[] = ['data' => $seprator.$v->option_name];
