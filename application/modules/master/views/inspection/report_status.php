...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_report_status_name'), 'class' => 'left', 'width' => '35%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover report_status_list">'];
