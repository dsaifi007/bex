...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_report_type_name'), 'class' => 'left', 'width' => '15%'],
    ['data' => $this->lang->line('tb_hd_report_featured'), 'class' => 'left', 'width' => '15%'],
    ['data' => $this->lang->line('tb_hd_report_drive_type'), 'class' => 'left', 'width' => '15%'],
    ['data' => $this->lang->line('tb_hd_report_no_of_drives'), 'class' => 'left', 'width' => '15%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover report_type_list">'];
            ...
            <div class="portlet-body">
                ...
                if (count($items) > 0) :
                    ...
                    foreach ($items as $k => $v) :
                        ...
                        $rowdata = [];
                        $rowdata[] = ['data' => $v->type_name];
                        $rowdata[] = ['data' => $boolean_arr[$v->featured]];
                        $rowdata[] = ['data' => $v->drive_type_name];
                        $rowdata[] = ['data' => $v->no_of_drives];
