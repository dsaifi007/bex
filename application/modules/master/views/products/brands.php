...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_brand_name'), 'class' => 'left', 'width' => '30%'],
    ['data' => $this->lang->line('tb_hd_toxic'), 'class' => 'text-center', 'width' => '10%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover brands_list">'];
            ...
            <div class="portlet-body">
                ...
                if (count($items) > 0) :
                    ...
                    foreach ($items as $k => $v) :
                        ...
                        $rowdata = [];
                        $rowdata[] = ['data' => $v->brand_name];
						$rowdata[] = ['data' => $boolean_arr[$v->toxic],'class' => 'text-center'];
