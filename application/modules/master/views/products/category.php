...
$table_heads = [
    //['data' => $this->lang->line('tb_hd_frontend_name'), 'class' => 'left','width' => '20%'],
    ['data' => $this->lang->line('tb_hd_backend_name'), 'class' => 'left','width' => '20%'],
    ['data' => $this->lang->line('tb_hd_category_type'), 'class' => 'left','width' => '15%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover category_list">'];
            ...
            <div class="portlet-body">
                ...
                if (count($items) > 0) :
                    ...
                    foreach ($items as $k => $v) :
                        ...
                        $rowdata = [];
                        //$rowdata[] = ['data' => $v->frontend_name];
                        $rowdata[] = ['data' => $v->backend_name];
                        $rowdata[] = ['data' => $v->category_type_name];
