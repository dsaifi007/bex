...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_category_type_name'), 'class' => 'left', 'width' => '40%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover category_type_list">'];
