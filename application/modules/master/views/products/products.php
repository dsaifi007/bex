...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_product_name'), 'class' => 'left', 'width' => '30%'],
    ['data' => $this->lang->line('tb_hd_brand_name'), 'class' => 'left', 'width' => '20%'],
    ['data' => $this->lang->line('tb_hd_toxic'), 'class' => 'left', 'width' => '10%'],
            ...
            <div class="portlet-body">
                ...
                if (count($items) > 0) :
                    ...
                    foreach ($items as $k => $v) :
                        ...
                        $rowdata[] = ['data' => (isset($brand_name[$v->brands_id])) ? $brand_name[$v->brands_id] :''];
                        $rowdata[] = ['data' => $boolean_arr[$v->toxic]];
