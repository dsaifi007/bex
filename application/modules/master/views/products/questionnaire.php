...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_question_name'), 'class' => 'left', 'width' => '30%'],
	['data' => $this->lang->line('tb_hd_type_name'), 'class' => 'left', 'width' => '10%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover questionnaire_list">'];
            ...
            <div class="portlet-body">
                ...
                if (count($items) > 0) :
                    ...
                    foreach ($items as $k => $v) :
                        ...
                        $rowdata[] = ['data' => $seprator.$v->question];
						$rowdata[] = ['data' => $field_types_list[$v->field_type]];
