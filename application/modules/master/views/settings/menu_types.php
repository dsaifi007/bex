...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_menu_type_title'), 'class' => 'left', 'width' => '25%'],
    ['data' => $this->lang->line('tb_hd_menu_type_slug'), 'class' => 'left hidden-xs', 'width' => '15%'],
    ['data' => $this->lang->line('tb_hd_menu_type_domain'), 'class' => 'left hidden-xs', 'width' => '20%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover menu_types_list">'];
            ...
            <div class="portlet-body">
                ...
                if (count($items) > 0) :
                    ...
                    foreach ($items as $k => $v) :
                        ...
                        $rowdata[] = ['data' => $v->menu_type_slug, 'class'=> 'hidden-xs'];
