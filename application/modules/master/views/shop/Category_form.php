    ...
    <div class="col-md-12">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                ...
                echo form_input_wrapper(lbl_req() . form_label($this->lang->line('categories_name_lbl'), 'category_name', ['class' => $label_cls]), form_input($input_category_name), ['inpt_grp_icon' => 'star-o']);
                ...
                echo form_input_wrapper(form_label($this->lang->line('categories_stores_lbl').lbl_req(), 'stores_id', ['class' => $label_cls]), form_multiselect('stores[]', $stores_list, set_value('stores', $item->stores), $stores_attr), ['inpt_grp_icon'=>'users']);
