...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_manufacturers'), 'class' => 'left', 'width' => '35%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover manufacturers_list">'];
