...
$table_heads = [
    ['data' => $this->lang->line('table_head_label'), 'class' => 'left', 'width' => '30%'],
    ['data' => $this->lang->line('tb_hd_stores_domain'), 'class' => 'left', 'width' => '25%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover stores_list">'];
