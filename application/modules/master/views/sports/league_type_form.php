...
$form_attributes = ['class' => 'league_type_form', 'id' => 'leaguetypeform'];
$btndata = ['name' => 'submit', 'id' => 'btn-league-type', 'content' => '<span class="ladda-label">' . $this->lang->line('submit_btn') . '</span>', 'value' => 'submit', 'type' => 'submit', 'class' => 'btn blue uppercase ladda-button', 'data-style' => 'zoom-out', 'data-size' => 's'];
?>
...
<?php echo display_portlet_title($this->lang->line('table_head_label'), display_form_head_links($list_link, $add_link)); ?>
            <div class="portlet-body form">
                ...
                echo form_input_wrapper(form_label($this->lang->line('league_type_name_lbl').lbl_req(), 'type_name', ['class' => $label_cls]), form_input($input_type_name), ['inpt_grp_icon' => 'envelope']);
