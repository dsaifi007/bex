...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_type_name'), 'class' => 'left', 'width' => '40%'],
    ['data' => $this->lang->line('tb_hd_league_type'), 'class' => 'left', 'width' => '20%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover match_types_list">'];
            ...
            <div class="portlet-body">
                ...
                if (count($items) > 0) :
                    ...
                    foreach ($items as $k => $v) :
                        ...
                        $rowdata[] = ['data' => $v->league_type_name];
