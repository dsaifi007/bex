...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_stand_name'), 'class' => 'left', 'width' => '30%'],
    ['data' => $this->lang->line('tb_hd_stadium_name'), 'class' => 'left', 'width' => '30%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover stadium_stands_list">'];
