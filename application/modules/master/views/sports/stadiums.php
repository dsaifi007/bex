...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_stadium_name'), 'class' => 'left', 'width' => '40%'],
    ['data' => $this->lang->line('tb_hd_country_code'), 'class' => 'left', 'width' => '20%'],
    /*['data' => $this->lang->line('tb_hd_state'), 'class' => 'left', 'width' => '10%'],
    ['data' => $this->lang->line('tb_hd_city'), 'class' => 'left', 'width' => '10%'],
    ['data' => $this->lang->line('tb_hd_zipcode'), 'class' => 'left', 'width' => '10%'],*/
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover stadiums_list">'];
            ...
            <div class="portlet-body">
                ...
                if (count($items) > 0) :
                    ...
                    foreach ($items as $k => $v) :
                        ...
                        $rowdata = [];
                        $rowdata[] = ['data' => $v->stadium_name];
                        $rowdata[] = ['data' => (isset($countries_list[$v->country_code]))? $countries_list[$v->country_code]:''];
                        /*$rowdata[] = ['data' => $v->state];
                        $rowdata[] = ['data' => $v->city];
                        $rowdata[] = ['data' => $v->zipcode];*/
