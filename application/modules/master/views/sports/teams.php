...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_team_name'), 'class' => 'left', 'width' => '30%'],
    ['data' => $this->lang->line('tb_hd_team_league_type'), 'class' => 'left', 'width' => '15%'],
    ['data' => $this->lang->line('tb_hd_team_country'), 'class' => 'left', 'width' => '15%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover teams_list">'];
            ...
            <div class="portlet-body">
                ...
                if (count($items) > 0) :
                    ...
                    foreach ($items as $k => $v) :
                        ...
                        $rowdata = [];
                        $rowdata[] = ['data' => $v->team_name];
						$rowdata[] = ['data' => (isset($league_types_list[$v->league_type_id]))? $league_types_list[$v->league_type_id]:''];
