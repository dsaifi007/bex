...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_league_name'), 'class' => 'text-center', 'width' => '10%'],
    ['data' => $this->lang->line('tb_hd_standium_name'), 'class' => 'text-center', 'width' => '10%'],
    ['data' => $this->lang->line('tb_hd_stand_name'), 'class' => 'text-center', 'width' => '10%'],
    ['data' => $this->lang->line('tb_hd_match_date'), 'class' => 'text-center', 'width' => '30%'],
    ['data' => $this->lang->line('tb_hd_ticket_price'), 'class' => 'text-center',  'width' => '10%'],
            ...
            <div class="portlet-body">
                ...
                if (count($items) > 0) :
                    ...
                    foreach ($items as $k => $v) :
                        ...
                        $rowdata = [];
						$rowdata[] = ['data' => (isset($league_id[$v->league_id]))? $league_id[$v->league_id]:''];
                        $rowdata[] = ['data' => (isset($stadium_id[$v->stadium_id]))? $stadium_id[$v->stadium_id]:''];  
                        $rowdata[] = ['data' => (isset($stadium_stand_id[$v->stadium_stand_id]))? $stadium_stand_id[$v->stadium_stand_id]:''];                    
                        $rowdata[] = ['data' => (isset($match_id[$v->match_id]))? $match_id[$v->match_id]:''];  
                        $rowdata[] = ['data' => $v->ticket_pricing];                   
