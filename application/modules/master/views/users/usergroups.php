...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_usergroup'), 'class' => 'left', 'width' => '50%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover usergroups_list">'];
