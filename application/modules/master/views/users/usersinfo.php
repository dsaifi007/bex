...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_name'), 'class' => 'left', 'width' => '20%'],
    ...
    ['data' => $this->lang->line('tb_hd_user_last_login'), 'class' => 'hidden-xs', 'width' => '15%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover usersinfo_list">'];
