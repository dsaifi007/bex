...
$form_attributes = ['class' => 'us-dl-state-form', 'id' => 'usdlstateform'];
...
<?php echo display_portlet_title($this->lang->line('table_head_label'), display_form_head_links($list_link, $add_link)); ?>
            <div class="portlet-body form">
                ...
                $input_acl_action = ['name' => 'state_name', 'type' => 'text', 'id' => 'state_name', 'autocomplete' => 'off', 'class' => $input_cls, 'value' => set_value('state_name', $item->state_name), 'required' => 'required', 'maxlength' => '50', 'placeholder' => ''];
                echo form_input_wrapper(form_label($this->lang->line('state_name_lbl').lbl_req(), 'state_name', ['class' => $label_cls]), form_input($input_acl_action), ['inpt_grp_icon' => 'cog']);
