...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_us_dl_state'), 'class' => 'left', 'width' => '35%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover us_dl_states_list">'];
