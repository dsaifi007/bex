...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_zip_codes'), 'class' => 'left', 'width' => '20%'],
    ['data' => $this->lang->line('tb_hd_city'), 'class' => 'left', 'width' => '15%'],
    ['data' => $this->lang->line('tb_hd_county'), 'class' => 'left hidden-xs', 'width' => '15%'],
    ['data' => $this->lang->line('tb_hd_state'), 'class' => 'left', 'width' => '15%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover zipcodes_list">'];
?>
