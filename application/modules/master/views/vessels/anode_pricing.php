...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_anode_name'), 'class' => 'left', 'width' => '20%'],
    ['data' => $this->lang->line('tb_hd_anode_type'), 'class' => 'left', 'width' => '20%'],
    ['data' => $this->lang->line('tb_hd_anode_price'), 'class' => 'left', 'width' => '20%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover anode_pricing_list">'];
            ...
            <div class="portlet-body">
                ...
                if (count($items) > 0) :
                    ...
                    foreach ($items as $k => $v) :
                        ...
                        $rowdata = [];
                        $rowdata[] = ['data' => $v->anode_name];
                        $rowdata[] = ['data' => $v->anode_type_name];
                        $rowdata[] = ['data' => $currency_codes_list[$v->currency_code]['code'].nbs().$v->anode_price];
