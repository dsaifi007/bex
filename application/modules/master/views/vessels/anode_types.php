...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_anode_type_name'), 'class' => 'left', 'width' => '30%'],
    ['data' => $this->lang->line('tb_hd_currency_code_lbl'), 'class' => 'left', 'width' => '30%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover anode_types_list">'];
