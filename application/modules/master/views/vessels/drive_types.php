...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_drive_type_name'), 'class' => 'left', 'width' => '60%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover drive_types_list">'];
