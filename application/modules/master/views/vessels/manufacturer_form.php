...
$form_attributes = ['class' => 'manufacturer_form', 'id' => 'manufacturerform'];
    ...
    <div class="col-md-12">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                ...
                $input_type_name = ['name' => 'manufacturer_name', 'type' => 'text', 'id' => 'manufacturer_name', 'autocomplete' => 'off', 'class' => $input_cls, 'value' => set_value('manufacturer_name', $item->manufacturer_name), 'required' => 'required', 'maxlength' => '50', 'placeholder' => ''];
                echo form_input_wrapper(form_label($this->lang->line('manufacturer_name_lbl').lbl_req(), 'manufacturer_name', ['class' => $label_cls]), form_input($input_type_name), ['inpt_grp_icon' => 'envelope']);
