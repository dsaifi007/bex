...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_price_label'), 'class' => 'left', 'width' => '20%'],
    ['data' => $this->lang->line('tb_hd_price_type'), 'class' => 'left', 'width' => '20%'],
    ['data' => $this->lang->line('tb_hd_price'), 'class' => 'left', 'width' => '20%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover price_list">'];
            ...
            <div class="portlet-body">
                ...
                if (count($items) > 0) :
                    ...
                    foreach ($items as $k => $v) :
                        ...
                        $rowdata = [];
                        $rowdata[] = ['data' => $v->price_label];
                        $rowdata[] = ['data' => $v->type_name];
                        $rowdata[] = ['data' => $currency_codes_list[$v->currency_code]['code'].nbs().$v->price];
