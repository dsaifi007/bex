...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_schedule_name'), 'class' => 'left', 'width' => '20%'],
    ['data' => $this->lang->line('tb_hd_range_from'), 'class' => 'left', 'width' => '20%'],
    ['data' => $this->lang->line('tb_hd_range_to'), 'class' => 'left', 'width' => '20%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover schedule_list">'];
            ...
            <div class="portlet-body">
                ...
                if (count($items) > 0) :
                    ...
                    foreach ($items as $k => $v) :
                        ...
                        $rowdata = [];
                        $rowdata[] = ['data' => $v->schedule_name];
                        $rowdata[] = ['data' => $v->range_from];
                        $rowdata[] = ['data' => $v->range_to];
