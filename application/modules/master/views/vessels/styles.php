...
$table_heads = [
    ['data' => $this->lang->line('tb_hd_style_name'), 'class' => 'left', 'width' => '60%'],
...
$template_active = ['table_open' => '<table class="table table-striped table-bordered table-hover styles_list">'];
