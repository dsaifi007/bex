...
$form_attributes = ['class' => 'type_form', 'id' => 'typeform'];
$btndata = ['name' => 'submit', 'id' => 'btn-type', 'content' => '<span class="ladda-label">' . $this->lang->line('submit_btn') . '</span>', 'value' => 'submit', 'type' => 'submit', 'class' => 'btn blue uppercase ladda-button', 'data-style' => 'zoom-out', 'data-size' => 's'];
?>
    ...
    <div class="col-md-12">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                ...
                echo form_input_wrapper(form_label($this->lang->line('type_name_lbl').lbl_req(), 'type_name', ['class' => $label_cls]), form_input($input_type_name), ['inpt_grp_icon' => 'envelope']);
